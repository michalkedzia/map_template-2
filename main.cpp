...
int main(void)
{
  ...
  // map_template<string,library> lib_database;

  // lib_database.Add("Adam Mickiewicz", library("Dziady cz.4","---","available",200));
  // lib_database.Add("Bolesław Brus", library("Lalka","---","available",2000));

  // cout << lib_database << endl;

  // library * book = lib_database.Find("Adam Mickiewicz");
  // book->status="loaned";
